        ...
        <div class="row">
            ...
            <div class="col-12">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php while($row = mysqli_fetch_assoc($my_query)): ?>

                            <tr>
                                <td><?php echo $row['id'] ?></td>
                                <td><?php echo $row['title'] ?></td>
                                <td>
                                    <a href="../handlers/delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> </a>
                                    
                                    <a href="update.php"<?php echo $row['id']; ?> class="btn btn-info"><i class="fa-solid fa-edit"></i> </a>
                                </td>
                            </tr>
                        <?php endwhile; ?>    
                    </tbody>
